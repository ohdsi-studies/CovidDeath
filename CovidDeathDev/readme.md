Developing models to predict death in patients hospitalized for COVID-19
========================================================

This package can be executed too develop models using data in the OMOP CDM.
...
```r
  library(CovidDeathDev)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./CovidDeathDevResults"
...
cohortTable <- 'CovidDeathDevCohort'
#=======================
