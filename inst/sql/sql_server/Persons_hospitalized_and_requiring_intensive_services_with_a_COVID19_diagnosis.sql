...
WHERE C.procedure_date > DATEFROMPARTS(2019, 12, 1)
...
WHERE C.observation_date > DATEFROMPARTS(2019, 12, 1)
...
WHERE C.value_as_concept_id in (4126681,45877990,9191,45884080,4181412,45879440)
-- End Measurement Criteria
